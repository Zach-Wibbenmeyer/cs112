...
//Runs the test in the MovieTester file
...
//Tests for the defaults in the constructors
...
//Tests the testOperator() method
void MovieTester::testOperator() const {
	cout << "Testing the Movie Comparison Method..." << endl;
	Movie m1("Blade Runner", 1982, "Ridley Scott");
	Movie m2("Blade Runner", 1982, "Ridley Scott");
	Movie m3("Bleh", 1982, "Ridley Scott");
	Movie m4("Blade Runner", 1984, "Ridley Scott");
	assert (m1 == m2);
	cout << " 1 " << flush;
	assert (!(m1 == m3));
	cout << " 2 " << flush;
